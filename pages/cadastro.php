    ...
    <div class="offset-3 col-6 justify-content-center mt-1">
        <form method="POST" action="" autocomplete="on">
            ...
            <input type="text" class="form-control" name="username" id="username" placeholder="Nome de Usuário">
                <div id="element01" class=""><span class="help-block">Nome de usuário não pode conter espaços.</span></div>
            <input type="email" class="form-control" name="email" id="email" placeholder="Email">
                <!--
                <div id="element02" class=""><span class="text-success">Endereço de email válido!</span></div>
                <div id="element03" class=""><span class="text-danger">Endereço de email inválido!</span></div>
                -->
            ...
            <input type="password" class="form-control" name="confirmpassword" id="confirmpassword" placeholder="Confirme a senha">
                <!--
                <div id="element04" class=""><span class="text-success">As senhas coincidem!</span></div>
                <div id="element05" class=""><span class="text-danger">As senhas não coincidem!</span></div><br>
                -->
